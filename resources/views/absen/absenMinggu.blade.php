...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl">
            <h3 class="mt-5 text-center txt">data absen sekolah Mingguan</h3>

            <div class="container d-flex flex-wrap justify-content-between">
                <h4 class="text-left txt">Geser untuk lebih lanjut >></h4>

                <form class="d-flex" action="/admin/absensi/minggu-ini" method="GET">
            ...
            <div class="container bo" style="overflow-y: auto">
                <a href="/exportpdf/mingguan" class="btn btn-danger mb-2" style="box-shadow: -5px 5px 7px grey;">
                    Export PDF
                    <i class="fa-solid fa-download"></i>
                </a>
                <a href="/exportexcel/migguan" class="btn btn-success mb-2" style="box-shadow: -5px 5px 7px grey;">
                    Export EXCEL
                    <i class="fa-solid fa-download"></i>
                </a>
                <div class="row">
                    <table class="table table-striped table-hover table-bordered tab">
                        ...
                        <tbody>
                            @php
                                $noabsen = 1;
                            @endphp
                            @foreach ($absenMingguan as $index => $items)
                                <tr>
                                    <th>{{ $index + $absenMingguan->firstItem() }}</th>
