...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl">
            <h3 class="mt-2 mb-2 text-center txt">data absen Migguan Kelas Anda</h3>

            <div class="container d-flex flex-wrap justify-content-between">
                <h4 class="text-left txt">Geser untuk lebih lanjut >></h4>

                <form class="d-flex" action="/guru/absen/mingguan" method="GET">
                    ...
                    <table class="table table-striped table-hover table-bordered tab">
                        ...
                        <tbody>
                            @php
                                $noabsen = 1;
                            @endphp
                            @foreach ($absensiMingguan as $index => $items)
                                <tr>
                                    <th>{{ $index + $absensiMingguan->firstItem() }}</th>
