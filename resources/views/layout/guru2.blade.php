...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">{{ Auth::guard('guru')->user()->tingkat }}
                    {{ Auth::guard('guru')->user()->jurusan }}</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/guru/absen/harian" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Hari ini</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/guru/absen/mingguan" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Minggu ini</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/guru/absen/bulan-ini" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Bulan ini</p>
                                    </a>
                                </li>
    ...
    <script>
        $('.delete').click(function(event) {
            ...
            Swal.fire({
                title: "Yakin ni Wirrr?",
                text: "nanti kena kick gegara ngehapus data " + nama + " ",
                icon: "warning",
