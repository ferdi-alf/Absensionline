...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('template/dist/img/avatar6.png') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/admin/absensi/harian" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Hari ini</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/absensi/minggu-ini" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Minggu ini</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/absensi/bulan-ini" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Bulan ini</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-header">Diagram Data Absen</li>
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/admin/diagram/data-X" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Tingkat X</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/diagram/data-XI" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Tingkat XI</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/diagram/data-XII" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Tingkat XII</p>
                                    </a>
                                </li>
    ...
    <script>
        $('.delete').click(function(event) {
            ...
            Swal.fire({
                title: "Peringatan!!",
                text: "Yakin ingin menghapus hak akses " + nama + " ",
                icon: "warning",
